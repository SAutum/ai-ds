...
def get_bad_psycopg_connect(code: str) -> Optional[str]:
    allowed_args = ["autocommit", "row_factory", "cursor_factory", "prepare_threshold", '""', "''"]
...
def test_and_zip(assignment: str = "rdda-7", max_size: int = 4 * 10**6) -> None:
    filenames = """
        exercise_1_a.py
        exercise_1_b.py
        exercise_2_a.py
        ...
        test_exercise_2_c.py
        test_exercise_2_d.py
        test_exercise_2_e.py
